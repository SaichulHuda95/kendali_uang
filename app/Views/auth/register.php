                        ...
                        <div class="card-body p-5 text-center">
                            ...
                            <div class="mb-md-3 mt-md-4 pb-5">
                                ...
                                <form action="<?= base_url() ?>/register/save" method="post">
                                    ...
                                    <button data-mdb-button-init data-mdb-ripple-init class="btn btn-primary btn-lg px-5 border" type="submit">Sign Up</button>
                                </form>

                            </div>

                            <div>
                                <p class="mb-0">Do you have an account? <a href="<?= base_url() ?>/login" class="fw-bold">Login</a>
                                </p>
                            </div>
